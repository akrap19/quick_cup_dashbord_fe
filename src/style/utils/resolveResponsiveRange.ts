import { Breakpoint, breakpointNames } from 'style/tokens/breakpoints'
...
export const resolveResponsiveRangeArray = (props: ResponsiveRangeProps): [boolean, boolean, boolean] => {
