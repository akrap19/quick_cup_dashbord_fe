...
const BuyAddPage = async () => {
	...
	const { data: clientsData } = await getClients({ search: '', page: 1, limit: 200 })
	...
	return <BuyAdd servicesPrices={servicesPrices} users={users} serviceLocations={serviceLocations} />
}
